...
<InstallTabs items={['CLI', 'Manual']}>
  ...
  <Tab value='CLI'>
    ...
    <KosoriCLITabs>
      ```bash tab="npm"
      npx @kosori/cli add components badge
      ```

      ```bash tab="pnpm"
      pnpx @kosori/cli add components badge
      ```

      ```bash tab="yarn"
      yarn dlx @kosori/cli add components badge
      ```

      ```bash tab="bun"
      bun x @kosori/cli add components badge
      ```
...
```json doc-gen:file
{
  "file": "./src/components/demos/badge/badge-intents.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
```json doc-gen:file
{
  "file": "./src/components/demos/badge/badge-sizes.tsx",
  "codeblock": true
}
```
</ComponentPreview>
