...
```json doc-gen:file
{
  "file": "./src/components/demos/toast/toast-intents.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
```json doc-gen:file
{
  "file": "./src/components/demos/toast/toast-simple.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
```json doc-gen:file
{
  "file": "./src/components/demos/toast/toast-title.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
```json doc-gen:file
{
  "file": "./src/components/demos/toast/toast-action.tsx",
  "codeblock": true
}
```
</ComponentPreview>
