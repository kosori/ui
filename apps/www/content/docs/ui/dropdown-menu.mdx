...
```json doc-gen:file
{
  "file": "./src/components/demos/dropdown-menu/dropdown-menu.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
<InstallTabs items={['CLI', 'Manual']}>
  ...
  <Tab value='CLI'>
    ...
    <KosoriCLITabs>
      ```bash tab="npm"
      npx @kosori/cli add components dropdown-menu
      ```

      ```bash tab="pnpm"
      pnpx @kosori/cli add components dropdown-menu
      ```

      ```bash tab="yarn"
      yarn dlx @kosori/cli add components dropdown-menu
      ```

      ```bash tab="bun"
      bun x @kosori/cli add components dropdown-menu
      ```
...
```json doc-gen:file
{
  "file": "./src/components/demos/dropdown-menu/dropdown-menu-checkboxes.tsx",
  "codeblock": true
}
```
</ComponentPreview>
...
```json doc-gen:file
{
  "file": "./src/components/demos/dropdown-menu/dropdown-menu-radio-group.tsx",
  "codeblock": true
}
```
</ComponentPreview>
