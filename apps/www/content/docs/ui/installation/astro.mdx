...
<Steps>
  ...
  <Step>
    ...
    <KosoriCLITabs>
      ```bash tab="npm"
      npm create astro@latest --add react --add tailwindcss
      ```

      ```bash tab="pnpm"
      pnpm create astro@latest --add react --add tailwindcss
      ```

      ```bash tab="yarn"
      yarn create astro@latest --add react --add tailwindcss
      ```

      ```bash tab="bun"
      bun create astro@latest --add react --add tailwindcss
      ```
