---
title: Manual
description: How to set up in your project manually.
---
...
<Steps>
  ...
  <Step>
    ...
    You can copy the dynamic styles from the floating navbar at the bottom of the page.
  ...
  <Step>
    ...
    Create the `cn` function to merge and have dynamic classes.
  ...
  <Step>
    ### Create Kosori config

    Create the `kosori.config.ts` file in the root of your project.

    ```ts title="kosori.config.ts"
    {
